...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ZooDB zooDB = new ZooDB();
        zooDB.create(shymzoo);
        AnimalDB animalDB = new AnimalDB();
        animalDB.create(aidos);
        ZookeeperDB zookeeperDB = new ZookeeperDB();
        zookeeperDB.create(askhat);
        zookeeperDB.update(askhat, "Daurenbek");
